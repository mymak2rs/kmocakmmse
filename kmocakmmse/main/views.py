    ...
    if machine:
        if pentagon != '-':
            ...
            if mocab_pentagon_result > 50:
                ...
                context['mocab_pentagon_result'] = str(np.round(100-mocab_pentagon_result, 2))
                
            if mocad_pentagon_result > 50:
                context['mocad_pentagon_decision'] = True
                context['mocad_pentagon_result'] = str(mocad_pentagon_result)
            else:
                context['mocad_pentagon_result'] = str(np.round(100-mocad_pentagon_result, 2))
        ...
        if mocab_machin_result > 50:
            ...
            context['mocab_machin_result'] = str(np.round(100-mocab_machin_result, 2))
            
        if mocad_machin_result > 50:
            context['mocad_machin_decision'] = True
            context['mocad_machin_result'] = str(mocad_machin_result)
        else:
            context['mocad_machin_result'] = str(np.round(100-mocad_machin_result, 2))
